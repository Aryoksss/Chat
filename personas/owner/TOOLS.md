...
## threads-dl
Description: Download video atau media dari Threads. Kasih link post Threads-nya.
Parameters:
...
## img-gen
Description: Generate gambar baru dari prompt, atau EDIT gambar yang dikirim/di-reply. Model FLUX AI. Default harus realistic/photorealistic; pakai anti-anime kecuali user minta anime.
Parameters:
...
## pap
Description: KHUSUS OWNER. DIPICU oleh kata "pap", "minta pap", "pap mu", "foto pap", "kirimin pap", dsb. Kirim/generate foto pap buat pemilik: kalau ada file di data/pap/ kirim satu acak (atau generate/edit dari foto itu via AI); kalau kosong generate via AI. JANGAN dipakai/dipanggil dari konteks grup — hanya saat chat pribadi owner. Saat owner minta pap, WAJIB panggil tool ini (jangan jawab hanya teks).
Parameters:
- prompt (string, optional) — arahan opsional buat generate kalau dataset kosong
